    ...
    <el-row class="warp">
        <el-col :span="24" class="warp-breadcrum">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item class="iconfont icon-asmkticon0252">饼图</el-breadcrumb-item>
            </el-breadcrumb>
        </el-col>
    
        <el-col :span="24" class="warp-main">
            <h3>访问来源</h3>
            <div id="pie1" style="width:80%; height:400px; margin:0 auto"></div>
        </el-col>
        <el-col :span="24" class="warp-main">
            <h3></h3>
            <div id="pie2" style="width:80%; height:400px;margin:0 auto"></div>
        </el-col>
        <el-col :span="24" class="warp-main">
            <h3></h3>
            <div id="pie3" style="width:80%; height:400px;margin:0 auto;margin-bottom:100px"></div>
        </el-col>
    </el-row>
</template>
<script>
import echarts from 'echarts'
import { option } from '../../common/echartsOptiong.js'
export default {
    data() {
        return {
            msg: 'hello vue',
